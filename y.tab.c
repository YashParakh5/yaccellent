...
{
  "$end", "error", "$undefined", "CONST_INT", "CONST_CHAR", "CONST_FLOAT",
  "id", "string", "enumeration_const", "CONST_STORAGE", "CONST_TYPE",
  "CONST_QUAL", "CONST_STRUCT", "CONST_ENUM", "DEFINE", "TOKEN_IF",
  "TOKEN_FOR", "TOKEN_DO", "TOKEN_WHILE", "TOKEN_BREAK", "TOKEN_SWITCH",
  "TOKEN_CONTINUE", "TOKEN_RETURN", "CASE", "DEFAULT", "TOKEN_GOTO",
  "TOKEN_SIZEOF", "PUNC", "DECISION_OR", "DECISION_AND",
  "DECISION_EQUALITY", "DECISION_SHIFT", "DECISION_EQLTY", "CONST_INC",
  "CONST_POINT", "CONST_PARAM", "TOKEN_ELSE", "HEADER", "'+'", "'-'",
  "'*'", "'/'", "\"then\"", "';'", "'{'", "'}'", "','", "'='", "':'",
  "'('", "')'", "'['", "']'", "'t'", "'?'", "'|'", "'^'", "'&'", "'<'",
  "'>'", "'%'", "'~'", "'!'", "'.'", "$accept", "program_unit",
